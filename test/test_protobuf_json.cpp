...
bool JsonToZeroCopyStream(const rapidjson::Document& document, 
...
TEST_F(ProtobufJsonTest, json_to_pb_normal_case) {
    ...
    for (int i = 0; i < N; ++i) {
        ...
        const bool ret = JsonToProtoMessage(info3, &data, &error);
        ...
        bool ret2 = ProtoMessageToJson(data, &info4, &error1);
...
TEST_F(ProtobufJsonTest, json_base64_string_to_pb_types_case) {
    ...
    JsonContextBody data;
    Json2PbOptions options_j2pb;
    options_j2pb.base64_to_bytes = true;
    const bool ret = JsonToProtoMessage(info3, &data, options_j2pb, &error);
    ASSERT_TRUE(ret);
    ...
    std::string info4;  
    std::string error1;
    Pb2JsonOptions options_pb2j;
    options_pb2j.bytes_to_base64 = true;
    bool ret2 = ProtoMessageToJson(data, &info4, options_pb2j, &error1);
    ASSERT_TRUE(ret2);
#ifndef RAPIDJSON_VERSION_0_1
...
TEST_F(ProtobufJsonTest, json_to_pb_map_case) {
    ...
    std::string error;
    AddressNoMap ab1;
    ASSERT_TRUE(JsonToProtoMessage(json, &ab1, &error));
    ASSERT_EQ("baidu.com", ab1.addr());

    AddressIntMap ab2;
    ASSERT_TRUE(JsonToProtoMessage(json, &ab2, &error));
    ...
    ASSERT_TRUE(JsonToProtoMessage(json, &ab3, &error));
    ...
    AddressComplex ab4;
    ASSERT_TRUE(JsonToProtoMessage(json, &ab4, &error)) << error;
    ...
    ab2.Clear();
    ASSERT_TRUE(JsonToProtoMessage(old_json, &ab2, &error)) << error;
    ASSERT_EQ("baidu.com", ab2.addr());
    ASSERT_EQ("tel", ab2.numbers(0).key());
    ASSERT_EQ(123456, ab2.numbers(0).value());
    ASSERT_EQ("cell", ab2.numbers(1).key());
...
TEST_F(ProtobufJsonTest, json_to_pb_encode_decode) {
    ...
    ASSERT_TRUE(JsonToProtoMessage(info3, &data, &error));

    std::string info4;  
    std::string error1;
    ASSERT_TRUE(ProtoMessageToJson(data, &info4, &error1));
#ifndef RAPIDJSON_VERSION_0_1
...
TEST_F(ProtobufJsonTest, json_to_pb_unicode_case) {
    ...
    bool ret = ProtoMessageToJson(address_book, &info1, &error);
    ASSERT_TRUE(ret);
    AddressBook address_book_test;
    ret = JsonToProtoMessage(info1, &address_book_test, &error);
    ASSERT_TRUE(ret);
    std::string info2;
    ret = ProtoMessageToJson(address_book_test, &info2, &error);
    ASSERT_TRUE(ret);
    ASSERT_TRUE(!info1.compare(info2));
    base::IOBuf buf;
    base::IOBufAsZeroCopyOutputStream stream(&buf); 
    bool res = ProtoMessageToJson(address_book, &stream, NULL);
    ASSERT_TRUE(res);
    base::IOBufAsZeroCopyInputStream stream2(buf); 
    AddressBook address_book_test3;
    ret = JsonToProtoMessage(&stream2, &address_book_test3, &error);
    ASSERT_TRUE(ret);
    std::string info3;
    ret = ProtoMessageToJson(address_book_test3, &info3, &error);
    ASSERT_TRUE(ret);
...
TEST_F(ProtobufJsonTest, json_to_pb_edge_case) {
    ...
    std::string error; 
    JsonContextBody data;
    bool ret = JsonToProtoMessage(info3, &data, &error);
    ASSERT_TRUE(ret);

    std::string info4;  
    std::string error1;
    ret = ProtoMessageToJson(data, &info4, &error1);
    ASSERT_TRUE(ret);
    ...
    ret = JsonToProtoMessage(info3, &data1, &error);
    ASSERT_TRUE(ret);
   
    info4.clear();  
    error1.clear();
    ret = ProtoMessageToJson(data1, &info4, &error1);
    ASSERT_TRUE(ret);
    ...
    ret = JsonToProtoMessage(info3, &data2, &error);
    ASSERT_TRUE(ret);
   
    info4.clear();  
    error1.clear();
    ret = ProtoMessageToJson(data2, &info4, &error1);
    ASSERT_TRUE(ret);
    ...
    ret = JsonToProtoMessage(info3, &data3, &error);
    ASSERT_TRUE(ret);
   
    info4.clear();  
    error1.clear();
    ret = ProtoMessageToJson(data3, &info4, &error1);
    ASSERT_TRUE(ret);
    ...
    ret = JsonToProtoMessage(info3, &data4, &error);
    ASSERT_TRUE(ret);
   
    info4.clear();  
    error1.clear();
    ret = ProtoMessageToJson(data4, &info4, &error1);
    ASSERT_TRUE(ret);
    ...
    ret = JsonToProtoMessage(info3, &data5, &error);
    ASSERT_TRUE(ret);
   
    info4.clear();  
    error1.clear();
    ret = ProtoMessageToJson(data5, &info4, &error1);
    ASSERT_TRUE(ret);
    ...
    ret = JsonToProtoMessage(info3, &data9, &error);
    ASSERT_TRUE(ret); 
    ...
    ret = JsonToProtoMessage(info3, &data10, &error);
    ASSERT_TRUE(ret); 
    ...
    ret = JsonToProtoMessage(info3, &data11, &error);
    ASSERT_TRUE(ret);   
...
TEST_F(ProtobufJsonTest, json_to_pb_expected_failed_case) {
    ...
    JsonContextBody data3;
    ret = JsonToProtoMessage(info3, &data, &error);
    ASSERT_FALSE(ret);
    ...
    ret = JsonToProtoMessage(info3, &data6, &error);
    ASSERT_FALSE(ret); 
    ...
    ret = JsonToProtoMessage(info3, &data7, &error);
    ASSERT_FALSE(ret);
    ...
    ret = JsonToProtoMessage(info3, &data8, &error);
    ASSERT_FALSE(ret);
...
TEST_F(ProtobufJsonTest, json_to_pb_perf_case) {
    ...
    for (int i = 0; i < times; i++) { 
        JsonContextBody data;
        timer.start();
        res = JsonToProtoMessage(info3, &data, &error);
        timer.stop();
        ...
        std::string error1;
        timer.start();
        res = ProtoMessageToJson(data, &info4, &error1);
        timer.stop();
...
TEST_F(ProtobufJsonTest, json_to_pb_complex_perf_case) {
    ...
    for (int i = 0; i < times; i++) { 
        ...
        res = JsonToProtoMessage(&stream, &data, options, &error);
        timer.stop();
        avg_time1 += timer.u_elapsed();
        ASSERT_TRUE(res);
    }
...
TEST_F(ProtobufJsonTest, json_to_pb_to_string_complex_perf_case) {
    ...
    for (int i = 0; i < times; i++) { 
        gss::message::gss_us_res_t data;
        timer.start();
        res = JsonToProtoMessage(info3, &data, options, &error);
        timer.stop();
        avg_time1 += timer.u_elapsed();
        ASSERT_TRUE(res);
    }
...
TEST_F(ProtobufJsonTest, pb_to_json_normal_case) {
    ...
    printf("----------test pb to json------------\n\n");
    Pb2JsonOptions option;
    option.bytes_to_base64 = true;
    bool ret = ProtoMessageToJson(address_book, &info1, option, NULL);
    ASSERT_TRUE(ret);
    ...
    info1.clear();
    {
        Pb2JsonOptions option;
        option.bytes_to_base64 = true;
        option.enum_option = OUTPUT_ENUM_BY_NUMBER;
        ret = ProtoMessageToJson(address_book, &info1, option, NULL);
    }
    ASSERT_TRUE(ret);
    ...
    for (int i = 0; i < N; ++i) {
        ...
        std::string error1;
        const int64_t tm1 = gettimeofday_us();
        bool ret1 = JsonToProtoMessage(info1, &data1, &error1); 
        const int64_t tm2 = gettimeofday_us();
        total_tm += tm2 - tm1;
        ASSERT_TRUE(ret1);
        ...
        std::string error2;
        const int64_t tm3 = gettimeofday_us();
        ret1 = ProtoMessageToJson(data1, &info3, &error2);
        const int64_t tm4 = gettimeofday_us();
        ASSERT_TRUE(ret1);
        total_tm2 += tm4 - tm3;
#ifndef RAPIDJSON_VERSION_0_1
...
TEST_F(ProtobufJsonTest, pb_to_json_map_case) {
    ...
    AddressNoMap ab1;
    ASSERT_TRUE(JsonToProtoMessage(json, &ab1, &error));
    ASSERT_TRUE(ProtoMessageToJson(ab1, &output, &error));
    ASSERT_TRUE(output.find("\"addr\":\"baidu.com\"") != std::string::npos);

    output.clear();
    AddressIntMap ab2;
    ASSERT_TRUE(JsonToProtoMessage(json, &ab2, &error));
    ASSERT_TRUE(ProtoMessageToJson(ab2, &output, &error));
    ASSERT_TRUE(output.find("\"addr\":\"baidu.com\"") != std::string::npos);
    ...
    AddressStringMap ab3;
    ASSERT_TRUE(JsonToProtoMessage(json, &ab3, &error));
    ASSERT_TRUE(ProtoMessageToJson(ab3, &output, &error));
    ASSERT_TRUE(output.find("\"addr\":\"baidu.com\"") != std::string::npos);
    ...
    output.clear();
    AddressComplex ab4;
    ASSERT_TRUE(JsonToProtoMessage(json, &ab4, &error));
    ASSERT_TRUE(ProtoMessageToJson(ab4, &output, &error));
    ASSERT_TRUE(output.find("\"addr\":\"baidu.com\"") != std::string::npos);
...
TEST_F(ProtobufJsonTest, pb_to_json_encode_decode) {
    ...
    std::string info3;
    JsonContextBody data1;
    JsonToProtoMessage(info1, &data1, NULL); 
    ProtoMessageToJson(data1, &info3, NULL);
#ifndef RAPIDJSON_VERSION_0_1
    ASSERT_STREQ("{\"info\":[\"this is json data's info\",\"this is a test\"],\"type\":80000,"
                 "\"data:array\":[200,300],\"judge\":true,\"spur\":3.45,\"@Content_Test%@\":"
                 "[{\"uid*\":\"content info\",\"Distance_info_\":1234.56005859375,\"_ext%T_\":"
...
TEST_F(ProtobufJsonTest, pb_to_json_edge_case) {
    ...
    ret = ProtoMessageToJson(address_book, &info1, &error);
    ...
    std::string error2;
    bool ret2 = ProtoMessageToJson(data1, &info3, &error2);
    ASSERT_TRUE(ret2);
...
TEST_F(ProtobufJsonTest, pb_to_json_perf_case) {
    ...
    float avg_time2 = 0;
    const int times = 100000;
    ASSERT_TRUE(ProtoMessageToJson(address_book, &info1, NULL));
    for (int i = 0; i < times; i++) { 
        std::string info3;
        AddressBook data1;
        timer.start();
        res = JsonToProtoMessage(info1, &data1, NULL); 
        timer.stop();
        avg_time1 += timer.u_elapsed();
        ASSERT_TRUE(res);
        
        timer.start();
        res = ProtoMessageToJson(data1, &info3, NULL);
        timer.stop();
        avg_time2 += timer.u_elapsed();
        ASSERT_TRUE(res);
    }
...
TEST_F(ProtobufJsonTest, pb_to_json_encode_decode_perf_case) {
    ...
    ASSERT_TRUE(ProtoMessageToJson(json_data, &info1, NULL));
    ...
    for (int i = 0; i < times; i++) { 
        ...
        timer.start();
        res = JsonToProtoMessage(info1, &json_body, NULL); 
        timer.stop();
        avg_time1 += timer.u_elapsed();
        ASSERT_TRUE(res);
        
        timer.start();
        res = ProtoMessageToJson(json_body, &info3, NULL);
        timer.stop();
        avg_time2 += timer.u_elapsed();
        ASSERT_TRUE(res);
    }
...
TEST_F(ProtobufJsonTest, pb_to_json_complex_perf_case) {
    ...
    for (int i = 0; i < times; i++) { 
        ...
        base::IOBuf buf;
        base::IOBufAsZeroCopyOutputStream stream(&buf); 
        res = ProtoMessageToJson(data, &stream, &error1);
        timer.stop();
        avg_time2 += timer.u_elapsed();
        ASSERT_TRUE(res);
    }
...
TEST_F(ProtobufJsonTest, encode_decode_case) {
    ...
    ASSERT_FALSE(protobuf_json::encode_name(json_key, field_name));
    ASSERT_TRUE(field_name.empty());
    std::string json_key_decode; 
    ASSERT_FALSE(protobuf_json::decode_name(field_name, json_key_decode));
    ASSERT_TRUE(json_key_decode.empty());
    
    json_key = "_Afledk2e*_+%leGi___hE_Z278_t#";
    field_name.clear();
    protobuf_json::encode_name(json_key, field_name);
    ...
    protobuf_json::decode_name(field_name, json_key_decode);
    ...
    ASSERT_FALSE(protobuf_json::encode_name(empty_key, empty_result));
    ASSERT_TRUE(empty_result.empty() == true);
    ASSERT_FALSE(protobuf_json::decode_name(empty_result, empty_key));
...
TEST_F(ProtobufJsonTest, json_to_zero_copy_stream_normal_case) {
    ...
    std::string error;
    ASSERT_TRUE(ProtoMessageToJson(person, &wrapper, &error)) << error;
...
TEST_F(ProtobufJsonTest, zero_copy_stream_to_json_normal_case) {
    ...
    Person person;
    ASSERT_TRUE(JsonToProtoMessage(&wrapper, &person));
...
TEST_F(ProtobufJsonTest, extension_case) {
    ...
    Person person;
    ASSERT_TRUE(JsonToProtoMessage(json, &person));
    ASSERT_STREQ("coding", person.GetExtension(addressbook::hobby).data());
    std::string output;
    ASSERT_TRUE(ProtoMessageToJson(person, &output));
    ASSERT_EQ("{\"hobby\":\"coding\",\"name\":\"hello\",\"id\":9,\"datadouble\":2.2,\"datafloat\":1.0}", output);
}

TEST_F(ProtobufJsonTest, repeated_keys_in_map) {
    RepeatedKeysValue kvs;
    for (int i = 0; i < 10; ++i) {
        kvs.add_keys_value()->set_value("value");
    }
    std::string json;
    std::string err;
    ASSERT_TRUE(ProtoMessageToJson(kvs, &json, &err));
    std::cout << json << std::endl;
}

TEST_F(ProtobufJsonTest, rapidjson_document_to_json_normal_case) {
    std::string json = "{\"name\":\"hello\",\"id\":9,\"datadouble\":2.2,\"datafloat\":1.0}";
    rapidjson::Document doc;
    doc.Parse<0>(json.c_str());
    ASSERT_TRUE(!doc.HasParseError() && doc.IsObject());

    Person person;
    ASSERT_TRUE(JsonToProtoMessage(doc, &person));
    ASSERT_STREQ("hello", person.name().c_str());
    ASSERT_EQ(9, person.id());
    ASSERT_EQ(2.2, person.datadouble());
    ASSERT_EQ(1, person.datafloat());
